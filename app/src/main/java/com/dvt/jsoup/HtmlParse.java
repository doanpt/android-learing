...
//        this.file = file;
    ...
    private ExamResultItem getAllTDElementsExam(Element element, String code) {
        ...
        try {
            ...
            String linkClass=tdElements.get(2).getElementsByTag("a").get(0).attr("href");
            ...
            examResultItem = new ExamResultItem(tdName, tdPoint1, tdPoint2, tdPoint3, tdPointPGA, tdSemester,linkClass);
        } catch (Exception e) {
            return null;
        }
