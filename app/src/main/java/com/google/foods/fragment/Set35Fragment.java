...
public class Set35Fragment extends Fragment {
    private View view;
    ...
    private DatabaseReference food35;
    private static Set35Fragment set35Fragment;

    public static Set35Fragment getInstance(Context context) {
        if (set35Fragment == null) {
            set35Fragment = new Set35Fragment(context);
        }
        return set35Fragment;
    }
    ...
    public Set35Fragment() {
        mActivity = (MainActivity) getContext();
    }

    public Set35Fragment(Context context) {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        food35 = mDatabase.child(CommonValue.DATABASE_TABLE_FOOD);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        view = layoutInflater.inflate(R.layout.fragment_set35, null);
        initComponent();
        return view;
    }
    ...
    private void initComponent() {
        ...
        recyclerView = (RecyclerView) view.findViewById(R.id.recycler_set35);
        // use this setting to
    ...
    public void resetAdapter() {
        ...
        food35.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot snapshot) {
                foodList.clear();
                for (DataSnapshot postSnapshot : snapshot.getChildren()) {
                    ItemFood itemFood = postSnapshot.getValue(ItemFood.class);
                    if (itemFood.getType() == CommonValue.VALUE_FOOD_35_VND) {
